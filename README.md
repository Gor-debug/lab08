...
Скриншот:
<img width="1958" height="720" alt="image" src="https://github.com/user-attachments/assets/f6ed01d9-4739-4a64-b125-2a995b2454ee" />


4 Проверьте работу приложения через браузер.

Добавлены задачи: «подготовиться к экзаменам», «пойти погулять», «Sdelat otchot». После добавления они отобразились в списке.
